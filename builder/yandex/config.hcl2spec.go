...
type FlatConfig struct {
	...
	ImageHardwareGeneration   *string           `mapstructure:"image_hardware_generation" required:"false" cty:"image_hardware_generation" hcl:"image_hardware_generation"`
	ImageSecureBootTemplateID *string           `mapstructure:"image_secure_boot_template_id" required:"false" cty:"image_secure_boot_template_id" hcl:"image_secure_boot_template_id"`
	ImageVtpmEnabled          *bool             `mapstructure:"image_vtpm_enabled" required:"false" cty:"image_vtpm_enabled" hcl:"image_vtpm_enabled"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"image_hardware_generation":     &hcldec.AttrSpec{Name: "image_hardware_generation", Type: cty.String, Required: false},
		"image_secure_boot_template_id": &hcldec.AttrSpec{Name: "image_secure_boot_template_id", Type: cty.String, Required: false},
		"image_vtpm_enabled":            &hcldec.AttrSpec{Name: "image_vtpm_enabled", Type: cty.Bool, Required: false},
